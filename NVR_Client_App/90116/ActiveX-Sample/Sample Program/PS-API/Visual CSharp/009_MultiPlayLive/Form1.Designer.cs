namespace SimpleSample_LiveMulti
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.axipropsapiCtrl1.Location = new System.Drawing.Point(12, 21);
            ...
            this.axipropsapiCtrl2.Location = new System.Drawing.Point(340, 21);
            ...
            this.axipropsapiCtrl2.TabIndex = 1;
            this.axipropsapiCtrl2.OnSearchCB += new System.EventHandler(this.axipropsapiCtrl2_OnSearchCB);
            this.axipropsapiCtrl2.OnError += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnErrorEventHandler(this.axipropsapiCtrl2_OnError);
            this.axipropsapiCtrl2.OnDevStatus += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnDevStatusEventHandler(this.axipropsapiCtrl2_OnDevStatus);
            this.axipropsapiCtrl2.OnPlayStatusCB += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnPlayStatusCBEventHandler(this.axipropsapiCtrl2_OnPlayStatusCB);
            this.axipropsapiCtrl2.OnOpStatus += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnOpStatusEventHandler(this.axipropsapiCtrl2_OnOpStatus);
            this.axipropsapiCtrl2.OnImageRefresh += new System.EventHandler(this.axipropsapiCtrl2_OnImageRefresh);
            this.axipropsapiCtrl2.OnAlmStatusCB += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnAlmStatusCBEventHandler(this.axipropsapiCtrl2_OnAlmStatusCB);
            this.axipropsapiCtrl2.OnOpStatusCB += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnOpStatusCBEventHandler(this.axipropsapiCtrl2_OnOpStatusCB);
            this.axipropsapiCtrl2.OnAlmStatus += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnAlmStatusEventHandler(this.axipropsapiCtrl2_OnAlmStatus);
            this.axipropsapiCtrl2.OnFtpStatusCB += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnFtpStatusCBEventHandler(this.axipropsapiCtrl2_OnFtpStatusCB);
            this.axipropsapiCtrl2.OnPlayStatus += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnPlayStatusEventHandler(this.axipropsapiCtrl2_OnPlayStatus);
            this.axipropsapiCtrl2.OnRecStatusCB += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnRecStatusCBEventHandler(this.axipropsapiCtrl2_OnRecStatusCB);
            this.axipropsapiCtrl2.OnSearchExCB += new System.EventHandler(this.axipropsapiCtrl2_OnSearchExCB);
            this.axipropsapiCtrl2.OnRecordStatus += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnRecordStatusEventHandler(this.axipropsapiCtrl2_OnRecordStatus);
            this.axipropsapiCtrl2.OnRecStatus += new AxIPROPSAPILib._IipropsapiCtrlEvents_OnRecStatusEventHandler(this.axipropsapiCtrl2_OnRecStatus);
            // 
            // buttonLiveStart
            // 
            this.buttonLiveStart.Location = new System.Drawing.Point(12, 276);
            this.buttonLiveStart.Name = "buttonLiveStart";
            this.buttonLiveStart.Size = new System.Drawing.Size(100, 30);
            this.buttonLiveStart.TabIndex = 2;
            ...
            this.Text = "SimpleSample_LiveMulti";
