Public Class Form1
    ...
    '****************************************************************
    '* Function Name        : b_gCamPos_Click
    '* Overview             : Get position of camera
    '****************************************************************
    Private Sub b_gCamPos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_gCamPos.Click
        'Define variables
        Dim lChannel As Long
        Dim lRet As Long
        Dim lPan As Long
        ...
        If (gPlayStatus = 1) Then
            'GetCameraPosition
            lChannel = 1
            lRet = AxipropsapiCtrl1.GetCameraPosition(lChannel)
            Logging("[Function] GetCameraPosition:" & CStr(lRet))

            'Get camera position value
            lPan = AxipropsapiCtrl1.CameraPosPan
            lTilt = AxipropsapiCtrl1.CameraPosTilt
            lZoom = AxipropsapiCtrl1.CameraPosZoom
            lFocus = AxipropsapiCtrl1.CameraPosFocus
            Logging("[Function] Pan[" & lPan & "] Tilt[" & lTilt & "] Zoom[" & lZoom & "] Focus[" & lFocus & "]")
        Else
    ...
    '****************************************************************
    '* Function Name        : b_sCamPos_Click
    '* Overview             : The camera is moved to the specified position
    '****************************************************************
    Private Sub b_sCamPos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_sCamPos.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lPan As Long
        ...
        If (gPlayStatus = 1) Then
            ...
            lZoom = 10
            lFocus = 14
            lRet = AxipropsapiCtrl1.SetCameraPosition(lChannel, lPan, lTilt, lZoom, lFocus)
            Logging("[Function] SetCameraPosition:" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    '* Overview             : The camera is moved to the specified position
    '****************************************************************
    Private Sub b_sCamPos2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_sCamPos2.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lPan As Long
    ...
    '****************************************************************
    '* Function Name        : b_COP_NOP_Click
    '* Overview             : Call CameraOperation (NonOperation)
    '****************************************************************
    Private Sub b_COP_NOP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_COP_NOP.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
        Dim ldata As Long
        Dim lBlocking As Long
        ...
        If (gPlayStatus = 1) Then
            ...
            ldata = 0
            lBlocking = 0
            lRet = AxipropsapiCtrl1.CameraOperation(lChannel, lCommand, ldata, lBlocking)
            Logging("[Function] CameraOperation:" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    '****************************************************************
    '* Function Name        : b_COP_AT_Click
    '* Overview             : Call CameraOperation (AutoTrack)
    '****************************************************************
    Private Sub b_COP_AT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_COP_AT.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
    ...
    '****************************************************************
    '* Function Name        : b_COP_AP_Click
    '* Overview             : Call CameraOperation (AutoPan)
    '****************************************************************
    Private Sub b_COP_AP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_COP_AP.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
    ...
    '****************************************************************
    '* Function Name        : b_COP_AF_Click
    '* Overview             : Call CameraOperation (AutoFocus)
    '****************************************************************
    Private Sub b_COP_AF_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_COP_AF.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
    ...
    '****************************************************************
    '* Function Name        : b_COP_SP_Click
    '* Overview             : Call CameraOperation (Set Preset)
    '****************************************************************
    Private Sub b_COP_SP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_COP_SP.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
    ...
    '****************************************************************
    '* Function Name        : b_COP_CP_Click
    '* Overview             : Call CameraOperation (Call Preset)
    '****************************************************************
    Private Sub b_COP_CP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_COP_CP.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
    ...
    '****************************************************************
    '* Function Name        : b_COP_DP_Click
    '* Overview             : Call CameraOperation (Delete Preset)
    '****************************************************************
    Private Sub b_COP_DP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_COP_DP.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
