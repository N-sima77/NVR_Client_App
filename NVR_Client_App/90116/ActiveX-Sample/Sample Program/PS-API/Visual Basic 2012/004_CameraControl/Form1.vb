Public Class Form1
    ...
    Private Sub Form1_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        If (gPlayStatus = 1) Then
            ...
            lfocus = 0
            liris = 0
            lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
            Logging("[Function] CameraControl(Stop):" & CStr(lRet))
    ...
    '****************************************************************
    '* Function Name        : b_Left_Click
    '* Overview             : CameraControl Pan
    ' ****************************************************************
    Private Sub b_Left_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Left.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lpan As Long
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 0
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Left):" & CStr(lRet))
        Else
    ...
    '****************************************************************
    '* Function Name        : b_Right_Click
    '* Overview             : CameraControl Pan
    ' ****************************************************************
    Private Sub b_Right_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Right.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lpan As Long
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 0
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Right):" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    '****************************************************************
    '* Function Name        : b_Up_Click
    '* Overview             : CameraControl Tilt
    ' ****************************************************************
    Private Sub b_Up_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Up.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lpan As Long
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 0
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Up):" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    '****************************************************************
    '* Function Name        : b_Down_Click
    '* Overview             : CameraControl Tilt
    ' ****************************************************************
    Private Sub b_Down_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Down.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lpan As Long
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 0
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Down):" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    '****************************************************************
    '* Function Name        : b_Tele_Click
    '* Overview             : CameraControl Zoom
    ' ****************************************************************
    Private Sub b_Tele_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Tele.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lpan As Long
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 0
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Tele):" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    '****************************************************************
    '* Function Name        : b_Wide_Click
    '* Overview             : CameraControl Zoom
    ' ****************************************************************
    Private Sub b_Wide_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Wide.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lpan As Long
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 0
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Wide):" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    '****************************************************************
    '* Function Name        : b_Open_Click
    '* Overview             : CameraControl Iris
    ' ****************************************************************
    Private Sub b_Open_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Open.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lpan As Long
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 1
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Open):" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    Private Sub b_Close_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Close.Click
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 2
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Close):" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    Private Sub b_Stop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_Stop.Click
        ...
        If (gPlayStatus = 1) Then
	        ...
	        liris = 0
	        lRet = AxipropsapiCtrl1.CameraControl(lChannel, lpan, ltilt, lzoom, lfocus, liris)
	        Logging("[Function] CamControl(Stop):" & CStr(lRet))
        Else
	        Logging("[Message] No live.")
        End If
    End Sub
    ...
    Private Sub AxipropsapiCtrl1_MouseDownEvent(ByVal sender As Object, ByVal e As AxIPROPSAPILib._IipropsapiCtrlEvents_MouseDownEvent) Handles AxipropsapiCtrl1.MouseDownEvent
        ...
        Dim lRet As Long
        Dim lChannel As Long
        Dim lControlSizeX As Long
        Dim lControlSizeY As Long
        ...
        If (gPlayStatus = 1) Then
            ...
            lControlSizeX = 640
            lControlSizeY = 480
            lRet = AxipropsapiCtrl1.CameraCentering(lChannel, e.x, e.y, lControlSizeX, lControlSizeY)
            Logging("[Function] Click centering" & CStr(lRet) & " Position[X;" & CStr(e.x) & " Y:" & CStr(e.y) & "]")
        End If
    End Sub
End Class
