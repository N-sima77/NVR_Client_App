Public Class Form1
    ...
    '****************************************************************
    '* Function Name    : b_rStart_Click
    '* Overview         : Recording Start
    '****************************************************************
    Private Sub b_rStart_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_rStart.Click
        'Define variables
        Dim lRet As Long
        ...
        If (AxipropsapiCtrl1.UID > -1) Then
	        ...
	        lCommand = 1
	        lBlockmode = 1
	        lRet = AxipropsapiCtrl1.RecCtrl(lChannel, lCommand, lBlockmode)
	        Logging("[Function] RecCtrl:" & CStr(lRet))
        Else
	        Logging("[Message] No login.")
        End If
    End Sub
    '****************************************************************
    '* Function Name    : b_rStop_Click
    '* Overview         : Recording Start
    '****************************************************************
    Private Sub b_rStop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_rStop.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
