Public Class Form1
    ...
    '****************************************************************
    '* Function Name    : b_AlmOp_Click
    '* Overview         : Alarm reset
    '****************************************************************
    Private Sub b_AlmOp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_AlmOp.Click
        'Define variables
        Dim lRet As Long
        ...
        If (AxipropsapiCtrl1.UID > -1) Then
	        lChannel = 1
	        lCommand = 1
	        lBlocking = 1
	        lRet = AxipropsapiCtrl1.AlarmOperation(lChannel, lCommand, lBlocking)
	        Logging("[Function] AlarmOperation (Reset):" & CStr(lRet))
        Else
    ...
    '****************************************************************
    '* Function Name    : b_TriggerOn
    '* Overview         : Alarm Trigger on
    '****************************************************************
    Private Sub b_TriggerOn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_TriggerOn.Click
        'Define variables
        Dim lRet As Long
        Dim lChannel As Long
        Dim lCommand As Long
        ...
        If (AxipropsapiCtrl1.UID > -1) Then
	        ...
	        lBlocking = 1
	        lRet = AxipropsapiCtrl1.AlarmOperation(lChannel, lCommand, lBlocking)
	        Logging("[Function] AlarmOperation (ON):" & CStr(lRet))
        Else
	        Logging("[Message] No login.")
        End If
    End Sub
