Public Class Form1
    ...
    Private Sub b_PlayBack_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_PlayBack.Click
        ...
        If (gPlayStatus = 0) Then
            ...
            AxipropsapiCtrl1.FilePassword = ""

            'Start PlayBack
            stFileName = m_eFileName.Text
            lBlockmode = 0
            lRet = AxipropsapiCtrl1.PlayFile(stFileName, lBlockmode)
            Logging("[Function] PlayFile:" & CStr(lRet))
    ...
    '****************************************************************
    '* Function Name        : b_nFrame_Click
    '* Overview             : PlayControl Next frame
    '****************************************************************
    Private Sub b_nFrame_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_nFrame.Click
        'Define variables
        Dim lRet As Long
        Dim lCommand As Long
        Dim lSpeed As Long
    ...
    '****************************************************************
    '* Function Name        : b_pFrame_Click
    '* Overview             : PlayControl  Previous Frame
    '****************************************************************
    Private Sub b_pFrame_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_pFrame.Click        
        'Define variables
        Dim lRet As Long
        Dim lCommand As Long
        Dim lSpeed As Long
