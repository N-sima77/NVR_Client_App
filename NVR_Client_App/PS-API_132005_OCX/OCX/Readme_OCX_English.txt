#######################################################################
How to use PS-API OCX (* Name changed to OCX from V13.10)
                                               (c) i-PRO Co., Ltd. 2025
#######################################################################
...
1. NOTE
  ...
  When you use the following development tool with ActiveX control,
  please choose "ActiveX".
...
2. VERSION INFORMATION
  ...
  Package Name : PS-API OCX
  SDK Version  : V13.20.05

  File Name    : PS-API_132005_OCX.zip
...
4. CHANGE HISTORY
 ...
 @ @ @ @ @ @ @ @ @ @ @ i* However, the UID etc. set in the argument of Connect() should be the UID get with the GetUID property. j
                     ---Added property---
                      UIDEx
                 ...
                 [Remarks]
                 - Renamed from ActiveX to OCX.
                     (* The name change has no impact on the app.)
  ...
  Description  : [Supported Products]
                 ...
                 - Add the Microsoft Visual Basic 2012 and 
                   Microsoft Visual C # 2012 to application development environment.
  ...
  Description  : [Supported Products]
                 ...
                 - Changed the minimum value of argument focus of 
                   SetCameraPosition.
                   Changed the minimum value of CameraPosFocus.
  ...
  Description  : [Supported Product]
                 ...
                 - Added digital sign to dll/ocx/ax files.
                 ...
                 [PS-ALARM]
                 - Add Microsoft Windows Server 2008 R2 SP1 to System Environment.
                 - Added digital sign to dll/ocx file.
  ...
  Description  : [PS-API]
                 - Addressed the following issue:
                   ...
                   - When using TitleOperation method, access violation occurs.
  ...
  Description  : [PS-API]
                 ...
                 - Addressed the following issue:
                   ...
                   - When using GetDevTimeZone method or RecCtrl method from 
  ...
  Description  : [PS-API]
                   ...
                   - Add Visual C# 2005 as support development environment.
                   - The following Method are added.
                       SearchEx
                       GetDevTimeZone
                       FtpGet
                   ...
                   - The following Event is added.
                       OnSearchExCB
                       OnFtpStatusCB
                   - Addressed the issue that application cannot allocate 
                     new memory when application runs in high load condition 
                     for a long time.
  ...
  Description  : - Addressed the following issue:
                 ...
                 - Addressed the following issue:
                   ...
                   and the video image that was recorded in DST term is specified,
